<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RecipeBrowse.aspx.cs" Inherits="RecipesApp.RecipeBrowse" %>
            ...
            <asp:Repeater ID="Repeater1" runat="server">
                ...
                <ItemTemplate>
                    <div style="margin-bottom:50px;text-align:center;background-color=white;border-radius=25%">
                        ...
                        <asp:Button ID="btn2" runat="server" Text="See Nutritional Info" CommandArgument='<%#DataBinder.Eval(Container.DataItem, "Id")%>'  OnClick="MyBtnHandler2" />
                    </div>
                </ItemTemplate>
            </asp:Repeater>
